...
export default function SearchResults({
  ...
  return (
    <ResultsDiv className="hero">
      <div className="inner">
        <p className="details">
          50+ chỗ ở - <span className="date">{checkInDate}</span> từ{" "}
          <span className="date">{checkOutDate}</span> dành cho {router.query.guests}{" "}
          khách
        </p>
        <h1>Chỗ ở tại {router.query.location}</h1>
